...
class HomePage(Page):
    ...
    def _build_tools(self) -> None:
        ...
        row.addWidget(self.card_zapret, 1)
    ...
    def _build_check(self) -> None:
        ...
        for column, item in enumerate((
            self.stat_zapret, self.stat_tg, self.stat_dns, self.stat_uptime
        )):
    ...
    def _refresh(self) -> None:
        ...
        if tunnels and status.running:
            ...
            title = {"обход": "Работает обход", "Telegram": "Работает прокси Telegram",
                     "Smart DNS": "Работает только Smart DNS"}[active[0]]
            detail = {
    ...
    def apply_theme(self) -> None:
        ...
        for card in (self.card_zapret, self.card_tg, self.card_dns):
            card.apply_theme()
