"""Генерация иконки приложения: рубиновый щит с галочкой.
...
def build_icon() -> Image.Image:
    ...
    check = [
        (SIZE * 0.34, SIZE * 0.505),
        (SIZE * 0.455, SIZE * 0.615),
        (SIZE * 0.675, SIZE * 0.385),
    ]
    draw.line(check, fill=(255, 255, 255, 255), width=width, joint="curve")
    radius = width // 2
