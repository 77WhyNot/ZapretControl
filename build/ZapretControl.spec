...
a = Analysis(
    ...
    hiddenimports=["app", "app.ui.window", "app.core.tgws", "app.vendor.tgwsproxy",
                   "app.vendor.tgwsproxy.tg_ws_proxy", "cryptography"],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=EXCLUDES,
...
exe = EXE(
    ...
    name="ZapretControlTest" if TEST_BUILD else "ZapretControl",
    debug=False,
